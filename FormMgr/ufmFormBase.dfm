  ...
  object BarMgr: TdxBarManager
    ...
    object cmSubPeriodo: TdxBarSubItem
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'cmUltimos7dias'
        end
        item
          Visible = True
          ItemName = 'cmUltimos30dias'
        end>
    end
    object cmUltimos30dias: TdxBarLargeButton
      Caption = #218'ltimos 30 dias'
      Category = 0
      Hint = #218'ltimos 30 dias'
      Visible = ivAlways
    end
    object cmUltimos7dias: TdxBarButton
      Caption = #218'ltimos 7 dias'
      Category = 0
      Hint = #218'ltimos 7 dias'
      Visible = ivAlways
    end
    object cmDesdeOntem: TdxBarButton
      Caption = 'Desde ontem'
      Category = 0
      Hint = 'Desde ontem'
      Visible = ivAlways
