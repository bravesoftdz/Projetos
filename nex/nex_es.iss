...
DirExistsWarning=No
OutputBaseFilename=setup_nex_es_
...
Name: desktopicon; Description: Crear un icono en &desktop; Components: Servidor; GroupDescription: Ícones adicionais:
...
Name: autostarticon; Description: Ejecute automáticamente al iniciar Windows; Components: Servidor; GroupDescription: Ícones adicionais:
