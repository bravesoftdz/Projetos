object FrmNFCeImpedirDeslig: TFrmNFCeImpedirDeslig
  ...
  object cxLabel1: TcxLabel
    ...
    Margins.Bottom = 15
    Align = alTop
    Caption = 'Ative a emiss'#227'o de NFC-e'
    ParentFont = False
  ...
  object lbMsg: TcxLabel
    ...
    Align = alTop
    Caption = 
      'Sua loja j'#225' emitiu NFC-e. Dessa forma '#233' obrigat'#243'rio que todas as' +
      ' vendas realizadas desse momento em diante fa'#231'am a emiss'#227'o de NF' +
      'C-e.'
    ParentFont = False
    Style.Font.Charset = ANSI_CHARSET
    Style.Font.Color = clWindowText
