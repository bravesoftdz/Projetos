inherited fbProdutos: TfbProdutos
  ...
  inherited panPri: TLMDSimplePanel
    ...
    object Paginas: TcxPageControl
            ...
            object Grid: TcxGrid
              ...
              object TVprod: TcxGridDBTableView
                ...
                object TVprodID: TcxGridDBColumn
                  AlternateCaption = 'C'#243'digo Interno'
      ...
      object tsXML: TcxTabSheet
        Caption = 'Entrada de estoque via NF-e / XML NFe'
        ImageIndex = 1
      end
    end
  end
  inherited BarMgr: TdxBarManager
    ...
    object dxBarButton1: TdxBarButton
      Caption = 'Lan'#231'ar entrada via NFe / XML'
      Category = 0
      Hint = 'Lan'#231'ar entrada via NFe / XML'
      Visible = ivNever
  ...
  object Tab: TnxTable
    ...
    object TabEstoqueAtual: TExtendedField
      Alignment = taCenter
      FieldName = 'EstoqueAtual'
      DisplayFormat = '0.####'
      Precision = 19
    end
    object TabEstoqueMin: TExtendedField
      FieldName = 'EstoqueMin'
      Precision = 19
    end
    object TabEstoqueMax: TExtendedField
      FieldName = 'EstoqueMax'
      Precision = 19
    end
    object TabEstoqueRepor: TExtendedField
      FieldName = 'EstoqueRepor'
      Precision = 19
    end
    object TabEstoquePend: TExtendedField
      Alignment = taCenter
      FieldName = 'EstoquePend'
      Precision = 19
    end
    object TabEstoqueTot: TExtendedField
      Alignment = taCenter
  ...
  object repEtq: TfrxReport
    ...
    ReportOptions.LastChange = 42096.433066736100000000
    ...
    object Page1: TfrxReportPage
      ...
      object Etiquetas: TfrxMasterData
        ...
        Columns = 7
        ColumnWidth = 99.401574803149600000
  ...
  object repEditar: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 41862.352097719900000000
    ReportOptions.LastChange = 41862.352097719900000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
