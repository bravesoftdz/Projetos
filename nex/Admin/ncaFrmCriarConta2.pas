...
uses
  ...
  System.ImageList, dxLayoutcxEditAdapters, dxLayoutContainer,
  dxLayoutLookAndFeels, dxLayoutControl, cxImageComboBox;
...
type
  ...
  protected
    ...
    procedure salvaLic(aConta, aChaves: String; aDVA: String); override;
  public
    { Public declarations }
  end;
...
procedure TFrmCriarConta2.salvaLic(aConta, aChaves: String; aDVA: String);
begin
  inherited;
  Dados.CM.SalvaLic(aConta, aChaves, aDVA);
end;
