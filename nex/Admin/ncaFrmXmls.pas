...
type
  ...
  public
    procedure Mostrar(aChave, aXMLEnvio, aXMLRet, aXMLAprovado, aXMLretCanc, aXMLretInut: String; aSomenteSalvar: Boolean; aTipoDoc: Byte);
    { Public declarations }
  end;
...
const Pref : Array[1..4] of String = ('NFCE_', 'CFeSAT_', 'NFe_', 'CCE_');
begin
  Result := ExtractFilePath(ParamStr(0))+Pref[FTipoDoc]+aNome+'.xml';
end;
...
procedure TFrmXMLs.Mostrar(aChave, aXMLEnvio, aXMLRet, aXMLAprovado,
  aXMLretCanc, aXMLretInut: String; aSomenteSalvar: Boolean; aTipoDoc: Byte);
var I: Integer;  
begin
  FChave := aChave;
  FTipoDoc := aTipoDoc;
