object FrmDebito: TFrmDebito
  ...
  object tbPro: TnxTable
    ...
    object tbProEstoquePend: TFloatField
      FieldName = 'EstoquePend'
    end
    object tbProEstoqueTot: TFloatField
    ...
    object tbProcest: TLongWordField
      FieldName = 'cest'
    end
    object tbProtax_id: TLongWordField
      FieldName = 'tax_id'
    end
    object tbPromodST: TByteField
      FieldName = 'modST'
    end
    object tbProMVA: TnxMemoField
      FieldName = 'MVA'
      BlobType = ftMemo
    end
