inherited FrmConfig_Cupom: TFrmConfig_Cupom
  Caption = 'NFC-e'
  ClientHeight = 571
  ClientWidth = 739
      ...
      object tsOpcoes: TcxTabSheet
        ...
        object panOpcoes: TLMDSimplePanel
          ...
          object lc4: TdxLayoutControl
            ...
            object edsat_esq: TcxDBImageComboBox
              Left = 202
              Top = 286
              DataBinding.DataField = 'sat_esq'
              DataBinding.DataSource = DS
              ParentFont = False
              Properties.ImmediateDropDownWhenActivated = True
              Properties.ImmediatePost = True
              ...
              Properties.Items = <
                item
                  Description = 'Vers'#227'o mais atual (v0.07)'
                  ImageIndex = 0
                end
                item
                  Description = 'v0.06'
            ...
            object lcsat_esq: TdxLayoutItem
              Parent = lcgr_avancado
              AlignHorz = ahLeft
              CaptionOptions.Text = 'Vers'#227'o do Esquema do XML'
              Control = edsat_esq
              ControlOptions.ShowBorder = False
              Index = 4
            end
