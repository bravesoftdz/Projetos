...
uses
  ...
  cxImage, cxDBEdit, System.ImageList;
...
type
  ...
  public
    ...
    function Pesquisar(var aUsername, aNome: String; const aMostraMsg: Boolean = False): Boolean;
...
function TFrmFuncPesq.Pesquisar(var aUsername, aNome: String; const aMostraMsg: Boolean = False): Boolean;
begin
  FUpdating := True;
  try
    panMsgTopo.Visible := aMostraMsg;
    edBusca.Text := '';
    Tab.CancelRange;
