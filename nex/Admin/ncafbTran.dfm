inherited fbTran: TfbTran
            ...
            object Grid: TcxGrid
              ...
              object TV: TcxGridDBTableView
                ...
                object TVTipo: TcxGridDBColumn
                  ...
                  OnGetDisplayText = TVTipoGetDisplayText
                  HeaderAlignmentHorz = taCenter
                  MinWidth = 16
                ...
                object TVCaixaPag: TcxGridDBColumn
                  DataBinding.FieldName = 'CaixaPag'
                  Visible = False
                  VisibleForCustomization = False
                  VisibleForEditForm = bFalse
                end
        ...
        object tsCedula: TcxTabSheet
          ...
          object gridCedula: TcxGrid
            ...
            object tvCedula: TcxGridTableView
              ...
              DataController.Summary.SummaryGroups = <>
              DataController.OnAfterPost = tvCedulaDataControllerAfterPost
              ...
              Styles.Header = FrmCaixa.cxStyle1
              OnCustomDrawColumnHeader = tvCedulaCustomDrawColumnHeader
  ...
  inherited BarMgr: TdxBarManager
    ...
    object cmPagamento: TdxBarButton
      Caption = 'Editar Pagamento (F2)'
      Category = 0
      Hint = 'Editar Pagamento (F2)'
      Visible = ivAlways
      ImageIndex = 89
      PaintStyle = psCaptionGlyph
      ShortCut = 113
    ...
    object cmTraduzir: TdxBarLargeButton
      Caption = 'Traduzir Caixa'
      Category = 0
      Hint = 'Traduzir Caixa'
      Visible = ivNever
      OnClick = cmTraduzirClick
      AutoGrayScale = False
      GlyphLayout = glLeft
      LargeImageIndex = 38
    end
  ...
  object Q: TnxQuery
    ...
    object QNomePagEsp: TStringField
      FieldKind = fkLookup
    ...
    object QStatusNFE: TByteField
      FieldName = 'StatusNFE'
    end
    object QChaveNFE: TStringField
      FieldName = 'ChaveNFE'
      Size = 44
    end
    object QTipoNFE: TByteField
      FieldName = 'TipoNFE'
    end
    object QIncluidoEm: TDateTimeField
      FieldName = 'IncluidoEm'
    end
    object QExtra: TnxMemoField
      FieldName = 'Extra'
      BlobType = ftMemo
    end
    object QAmbNFe: TByteField
      FieldName = 'AmbNFe'
    end
    object QStatusCanc: TByteField
      FieldName = 'StatusCanc'
    end
    object Qtax_incluido: TCurrencyField
      FieldName = 'tax_incluido'
    end
    object Qtax_incluir: TCurrencyField
      FieldName = 'tax_incluir'
    end
    object QTotalFinal: TCurrencyField
      FieldName = 'TotalFinal'
    end
    object Qids_pagto: TStringField
      FieldName = 'ids_pagto'
    end
    ...
    object QComissao: TCurrencyField
      FieldName = 'Comissao'
    end
    object QNomeVendedor: TStringField
      FieldKind = fkLookup
    ...
    object Qendereco_entrega: TGuidField
      FieldName = 'endereco_entrega'
      Size = 38
    end
    object Qtranest: TBooleanField
      FieldName = 'tranest'
    end
    object Qtrancx: TBooleanField
      FieldName = 'trancx'
    end
    object QNomeTipo: TStringField
      FieldKind = fkLookup
      FieldName = 'NomeTipo'
      LookupDataSet = Dados.tbTipoTran
    ...
    object QVenDev: TBooleanField
      FieldName = 'VenDev'
    end
    object QHora: TByteField
      FieldName = 'Hora'
    end
    object QFrete: TCurrencyField
      FieldName = 'Frete'
    end
