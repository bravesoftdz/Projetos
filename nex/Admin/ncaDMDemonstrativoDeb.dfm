object dmDemonstrativoDeb: TdmDemonstrativoDeb
  ...
  object repBob_en: TfrxReport
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 38823.643521608800000000
    ReportOptions.LastChange = 42717.751254490700000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxDMPPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object DMPMemo2: TfrxDMPMemoView
          ...
          Height = 17.000000000000000000
          Memo.UTF8W = (
            'Total value On Account:')
          TruncOutboundText = False
        end
      end
    end
  end
  object repBob_es: TfrxReport
    Version = '5.5'
    DataSet = dbCab
    DataSetName = 'dbCab'
    DotMatrixReport = True
  ...
  object repFolha_en: TfrxReport
    ...
    ReportOptions.CreateDate = 38825.568748067100000000
    ReportOptions.Name = 'NEXCAFE_RECIBO'
    ReportOptions.LastChange = 42717.749483414400000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object Produtos: TfrxMasterData
        ...
        object Memo17: TfrxMemoView
          Align = baRight
          Left = 585.827245200000000000
          Top = 3.779529999999994000
          Width = 132.283454800000000000
          Height = 18.897650000000000000
          DataField = 'ValorDeb'
          DataSet = dbItem
          DataSetName = 'dbItem'
        ...
        object Memo4: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Purchased in [dbItem."DataCompra"]')
          ParentFont = False
        end
      end
      object ReportSummary1: TfrxReportSummary
        ...
        object dbTotPagValor: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Total on Account = [SUM(<dbItem."ValorDeb">,Produtos)]')
          ParentFont = False
        end
      end
    end
  end
  object repFolha_es: TfrxReport
    Version = '5.5'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator]
