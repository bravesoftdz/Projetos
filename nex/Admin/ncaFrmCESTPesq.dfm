object FrmCESTPesq: TFrmCESTPesq
  Left = 300
  Top = 420
  ActiveControl = Grid
  ...
  object panBusca: TLMDSimplePanel
    ...
    object lbBaixando: TcxLabel
      Left = 384
      Top = 0
      Align = alRight
      Caption = 'Atualizando tabela CEST ...'
      ParentFont = False
  ...
  object Tab: TnxTable
    ...
    object Tabncm: TLongWordField
      Alignment = taLeftJustify
      FieldName = 'ncm'
    end
    object Tabdescr: TnxMemoField
      FieldName = 'descr'
      BlobType = ftMemo
    end
    object Tabsrecver: TLongWordField
      FieldName = 'srecver'
    end
