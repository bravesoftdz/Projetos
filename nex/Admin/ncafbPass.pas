...
uses
  ...
  cxLookAndFeelPainters, cxNavigator, dxPScxPivotGridLnk;
...
begin
  ...
  try
    ...
    cmExpirar.Enabled := Permitido(daCliCorrigirCredito) and (not Tab.IsEmpty);
  finally
...
begin
  inherited;
  cmExpirar.Enabled := Permitido(daCliCorrigirCredito) and Tab.Active and (not Tab.IsEmpty);
end;
