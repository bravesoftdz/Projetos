...
resourcestring
  ...
  rsUltimoDiaExt = 'Seu plano está ativo. Hoje é o último dia para realizar o pagamento da sua assinatura NEX e evitar que os benefícios do seu plano sejam desativados.';
  rsDias = 'dias';
  rsDia  = 'dia';
