...
procedure Tdm_bk_post.DataModuleCreate(Sender: TObject);
begin
...
procedure Tdm_bk_post.Open;
begin
  tPost.Open;
  DebugMsg(Self, 'Open');
end;

procedure Tdm_bk_post.Processa;
...
function Tdm_bk_post._Term: Boolean;
begin
