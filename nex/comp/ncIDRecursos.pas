...
resourcestring
    ...
    rsDireito12 = 'Corrigir Crédito dos Clientes';
    ...
    rsDireito30 = 'Ver custo/lucro dos produtos e vendas';
    ...
    rsDireito63 = 'Receber pagamento de débitos';
    rsDireito64 = 'Acessar a lista de fornecedores';
    rsDireito65 = 'Ver transações de fornedores';
    rsDireito66 = 'Incluir, Alterar e ver a lista de Orçamentos';
    rsDireito67 = 'Excluir Orçamentos';
    rsDireito68 = 'Ver vendas realizadas no caixa atual';
    rsDireito69 = 'Ver vendas realizadas em caixas anteriores';
    rsDireito70 = 'Ver vendas com pagamento pendente';
    rsDireito71 = 'Fazer devolução de produto';
    rsDireito72 = 'Abrir gaveta de dinheiro sem realizar venda';
...
const
  ...
  daReceberPagDebito = 63;
  daFornecedoresVerLista = 64;
  daFornecedoresVerTran = 65;

  daOrcAcessar = 66;
  daOrcExcluir = 67;

  daVendasVerCxAtual = 68;
  daVendasVerCxAntes = 69;
  daVendasVerPend    = 70;
  ...
  daDefault = [daCliCadastrar, daProCadastrar, daCaiAbrirFechar, daCaiVerAtual, daIniciarSessaoCliCad, 
               ...
               daIniciarAcessoGratis, daVerTranCaixa, daVendaCaixa, daVendaBalcao, daVendaPagamento, 
