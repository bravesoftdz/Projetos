...
begin
  Result :=
    ...
    GetDTStr(idDataCompra) + sFldDelim(classid_TncItemDebito) +
...
begin
  ...
  if idDataCompra <> B.idDataCompra then Exit;
...
begin
  ...
  idDataCompra := D.FieldByName('Data').AsDateTime;
  idItemPos := 0;
...
procedure TncDebito.CreateGuid;
begin
...
function TncDebito.GetUID: String;
begin
...
function TncDebito.NativeGuid: TGuid;
begin
  Result := FUID;
end;
...
procedure TncDebito.SetUID(const Value: String);
begin
