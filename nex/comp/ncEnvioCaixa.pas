...
begin
 {
 o post pode ser feito para esta url: http://emailcaixanextar.herokuapp.com/

se acessar pelo browser, conseguem testar o envio no endereço: http://emailcaixanextar.herokuapp.com/test
}
    result := '';
