...
//CALLBACK TYPES
//*****************************************************
GRCAP_STATUS_EVENT_PROC = Procedure(idSensor: PAnsiChar; event: GRCAP_STATUS_EVENTS); stdcall;
GRCAP_FINGER_EVENT_PROC = Procedure(idSensor: PAnsiChar; event: GRCAP_FINGER_EVENTS); stdcall;
GRCAP_IMAGE_EVENT_PROC = Procedure(idSensor: PAnsiChar; width: Integer; height: Integer; rawImage: PAnsiChar; res: Integer); stdcall;
...
var GrCapStartCapture: function(idSensor: PAnsiChar; FingerEventHandler: GRCAP_FINGER_EVENT_PROC; ImageEventHandler: GRCAP_IMAGE_EVENT_PROC): Integer; stdcall;

var GrCapStopCapture: function(idSensor: PAnsiChar): Integer; stdcall;

var GrCapRawImageToHandle: function(rawImage: PAnsiChar; width, height: Integer; hdc: HDC; var handle: HBITMAP): Integer; stdcall;

var GrCapSaveRawImageToFile: function(rawImage: PAnsiChar; width, height: Integer; filename: String; imageFormat: GRCAP_IMAGE_FORMAT): Integer; stdcall;

var GrCapLoadImageFromFile: function(filename: String; res: Integer): Integer; stdcall;

var GrBiometricDisplay: function(templateQuery,rawImage: PAnsiChar; width, height,res: Integer; hdc: HDC; var handle: HBITMAP; context: Integer): Integer; stdcall;

var GrBiometricDisplayRaw: function(templateQuery,rawImage: PAnsiChar; width, height,res: Integer; outputImageRGB: PAnsiChar; context: Integer): Integer; stdcall;

//*****************************************************
// Functions - EXTRACT
//*****************************************************
var GrExtract: function(rawimage: PAnsiChar; width: Integer; height: Integer; res: Integer; tpt: PAnsiChar; var tptSize: Integer; context: Integer): Integer; stdcall;

var GrExtractEx: function(rawimage: PAnsiChar; width: Integer; height: Integer; res: Integer; tpt: PAnsiChar; var tptSize: Integer; context: Integer; tptFormat: Integer): Integer; stdcall;

//*****************************************************
// Functions - TEMPLATE CONVERSION
//*****************************************************

var GrConvertTemplate: function(oldTpt: PAnsiChar; newTpt: PAnsiChar; newTptSize: Integer; context: Integer; format: Integer): Integer; stdcall;
...
var GrEnroll: function(rawimage: PAnsiChar; width: Integer; height: Integer; res: Integer; tpt: PAnsiChar; var tptSize: Integer; var quality: Integer; tptFormat: Integer; context: Integer): Integer; stdcall;

//*****************************************************
// Functions - BASE64
//*****************************************************
var GrEncodeBase64: function(buffer: PAnsiChar; bufferSize:Integer; encodedBuffer: PAnsiChar; var encodedSize: Integer): Integer; stdcall;

var GrDecodeBase64: function(encodedBuffer: PAnsiChar; encodedSize:Integer; decodedBuffer: PAnsiChar; var decodedSize: Integer): Integer; stdcall;

var GrIsBase64Encoding: function(buffer: PAnsiChar; bufferSize:Integer): Boolean; stdcall;
...
var GrVerify: function(queryTemplate: PAnsiChar; referenceTemplate: PAnsiChar; var verifyScore: Integer; context: Integer): Integer; stdcall;

var GrIdentifyPrepare: function(templateQuery: PAnsiChar; context: Integer): Integer; stdcall;

var GrIdentify: function(templateReference: PAnsiChar; var identifyScore: Integer; context: Integer): Integer; stdcall;
...
begin
  @GP := GetProcAddress(DllHandle, PAnsiChar(Name));
end;
...
begin
  ...
  DllHandle := LoadLibraryA(PAnsiChar('GrFinger.dll'));
