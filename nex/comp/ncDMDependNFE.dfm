object dmDependNFE: TdmDependNFE
  ...
  object G: TLMDWebHTTPGet
    URL = 'http://baixar.programanex.com.br/extras/setup_nfe_depend.exe'
    DownloadDir = 'c:\nex'
    DestinationName = 'setup_nfe_depend.exe'
  ...
  object G2: TLMDWebHTTPGet
    URL = 'http://baixar.programanex.com.br/extras/setup_nfe_arqs.exe'
    DownloadDir = 'c:\nex'
    DestinationName = 'setup_nfe_arqs.exe'
    DownloadParams.SizeLimit = 0
