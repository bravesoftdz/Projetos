...
const
  ...
  ncerrExcecaoNaoTratada_TncServidor_ZerarEstoque               = 555;
  ncerrExcecaoNaoTratada_GetCertificados                        = 556;
  ncerrExcecaoNaoTratada_ReemitirNFCe                           = 557;
  ncerrExcecaoNaoTratada_GeraXMLProt                            = 558;
  ncerrExcecaoNaoTratada_ConsultarSAT                           = 559;
  ncerrExcecaoNaoTratada_InutilizarNFCE                         = 560;
  

  ncerrUltimo = ncerrExcecaoNaoTratada_InutilizarNFCE;
...
begin
  case Erro of
    ...
    ncerrExcecaoNaoTratada_TncServidor_ZerarEstoque : 
      Result := SncErros_ExceçãoNãoTratadaNoServidor_TncServidor_ZerarEstoque;

    ncerrExcecaoNaoTratada_GetCertificados : 
      Result := SncErros_ExcecaoNaoTratada_GetCertificados;

    ncerrExcecaoNaoTratada_ReemitirNFCe :
      Result := SncErros_ExcecaoNaoTratada_ReemitirNFCe;

    ncerrExcecaoNaoTratada_GeraXMLProt : 
      Result := SncErros_ExcecaoNaoTratada_GeraXMLProt;

    ncerrExcecaoNaoTratada_ConsultarSAT : 
      Result := SncErros_ExcecaoNaoTratada_ConsultarSAT; 

    ncerrExcecaoNaoTratada_InutilizarNFCE : 
      Result := SncErros_ExcecaoNaoTratada_InutilizarNFCE;
  else
    Result := '';    
  end;
end;
