...
Name: desktopicon; Description: Create icon on &desktop; Components: Servidor; GroupDescription: Ícones adicionais:
...
Name: autostarticon; Description: Run NexServ automatically on Windows startup; Components: Servidor; GroupDescription: Ícones adicionais:
