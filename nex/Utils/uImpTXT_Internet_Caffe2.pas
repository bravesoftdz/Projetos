...
{    if J=2 then begin
    ...
    ProxCampoRev;ProxCampoRev;ProxCampoRev;ProxCampoRev;
    ProxCampoRev;ProxCampoRev;ProxCampoRev;ProxCampoRev;
    ProxCampoRev;ProxCampoRev;ProxCampoRev;ProxCampoRev;
    ProxCampoRev;
    
    tCliTelefone.Value := ProxCampoRev;
    tCliEndereco.Value := S;
{    proxn(3);
    
    s3 := ProxCampo;
    sDoc := SoDig2(s3);
    if Length(sDoc)=11 then
      tCliCPF.Value := sDoc else
      tCliRG.Value := s3;
