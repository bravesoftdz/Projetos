...
type
  TForm16 = class(TForm)
    ...
    ADOTable1: TADOTable;
    ADOTable1objUsuario: TAutoIncField;
    ADOTable1sLogin: TWideStringField;
    ADOTable1sNome: TWideStringField;
    ADOTable1sSobrenome: TWideStringField;
    ADOTable1sEndereco: TWideStringField;
    ADOTable1sBairro: TWideStringField;
    ADOTable1sCidade: TWideStringField;
    ADOTable1iCep: TIntegerField;
    ADOTable1sSenha: TWideStringField;
    ADOTable1dCadastro: TDateTimeField;
    ADOTable1iTelefoneDDD: TSmallintField;
    ADOTable1iTelefone: TIntegerField;
    ADOTable1bStatus: TBooleanField;
    ADOTable1iAcessos: TIntegerField;
    ADOTable1mDebito: TBCDField;
    ADOTable1sObs: TWideMemoField;
    ADOTable1sEmail: TWideStringField;
    ADOTable1bCortesia: TBooleanField;
    ADOTable1bPosPago: TBooleanField;
    ADOTable1bTicket: TBooleanField;
    ADOTable1iDias: TIntegerField;
    ADOTable1iDesc: TIntegerField;
    ADOTable1mValorDif: TBCDField;
    ADOTable1sIdentidade: TWideStringField;
    ADOTable1dDataNasc: TDateTimeField;
    ADOTable1objFuncionario: TIntegerField;
    ADOTable1bLockUser: TBooleanField;
    ADOTable1sPai: TWideStringField;
    ADOTable1sMae: TWideStringField;
    ADOTable1sEscola: TWideStringField;
    ADOTable1sHorario1: TWideStringField;
    ADOTable1sHorario2: TWideStringField;
    ADOTable2: TADOTable;
    ADOTable2objUsuario: TIntegerField;
    ADOTable2sTempoEstimado: TWideStringField;
    ADOTable2dInicio: TDateTimeField;
    ADOTable2dFim: TDateTimeField;
    ADOTable2bCrashServer: TBooleanField;
