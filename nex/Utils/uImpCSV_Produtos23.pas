...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    tProdObs.Value := 'NCM='+ProxCampo;
    tProdObs.Value := tProdObs.Value+sLineBreak+'Classe_ICMS='+ProxCampo;
    tProdObs.Value := tProdObs.Value+sLineBreak+'Classe_PIS_COFINS='+ProxCampo;
