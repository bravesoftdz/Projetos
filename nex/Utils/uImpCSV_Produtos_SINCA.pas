...
function GetGrupo(S: String): String;
const Grupos: Array[1..41] of String = (
  'Geral',
  'TORNEIRAS', 
  'ACESSORIOS BANHEIRO',
  'CHUVEIROS', 
...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    ProxCampo;
    try
      tProdIncluidoEm.Value := StrToDate(ProxCampo);
      tProdIncluidoEm.Value := tProdIncluidoEm.Value + StrToTime(ProxCampo);
    except
      raise;
    end;
    ProxCampo; ProxCampo;
    ...
    ProxCampo;
    tProdCategoria.Value := GetGrupo(ProxCampo);
    ProxN(4);
    tProdEstoqueMax.Value := StrToIntDef(ProxCampo, 0);
