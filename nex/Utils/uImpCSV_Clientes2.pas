...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    if tCliCelular.Value>'' then
      tCliCodigo.Value := tCliCelular.Value else
      tCliCodigo.Value := tCliTelefone.Value;

    if tCliCodigo.Value='' then tCliCodigo.Value := IntToStr(I);
