...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    s2 := ProxCampo;
    if s2>'' then
      tProdObs.Value := 'Classificação Fiscal: ' + s2;
    ...
    tProdEstoqueMax.Value := StrToFloatDef(ProxCampo, 0);
    tProdEstoqueMin.Value := StrToFloatDef(ProxCampo, 0);
