unit uImpCSV_Produtos_NEX_armadillo;
...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    S := SL[I];  
    s2 := ProxCampo;
    if not tProd.FindKey([s2]) then begin
      tProd.Append;
      ...
      tProdFornecedor.Value := Fornecedor('Custom', '');
      proxCampo;
    ...
    tProd.Edit;
    tProdEstoqueAtual.Value := tProdEstoqueAtual.Value + 1;
    tProd.Post;
  end;
end;
