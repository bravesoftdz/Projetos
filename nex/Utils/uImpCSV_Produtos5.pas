...
begin
  if aEstoque<1 then Exit;
  
  tProd.Append;
  tProdDescricao.Value := sDescr + ' - Ref.'+sRef+' - Tam.'+aTam;
  tProdEstoqueAtual.Value := aEstoque;
  tProdCodigo.Value := sRef;
  tProd.Post;
  ...
  tEstCategoria.Value := tProdCategoria.Value;
