object Form16: TForm16
  ...
  object tF: TDbf
    ...
    IndexDefs = <>
    TableName = 'Member.DBF'
    TableLevel = 3
    Left = 456
    Top = 72
    object tFUID: TFloatField
      FieldName = 'UID'
    end
    object tFID: TFloatField
      FieldName = 'ID'
    end
    object tFDATE: TDateField
      FieldName = 'DATE'
    end
    object tFLASTMODIFI: TDateField
      FieldName = 'LASTMODIFI'
    end
    object tFNAME: TStringField
      FieldName = 'NAME'
    end
    object tFUSERID: TStringField
      FieldName = 'USERID'
    end
    object tFPASSWORD: TStringField
      FieldName = 'PASSWORD'
    end
    ...
    object tFJUMINID: TStringField
      FieldName = 'JUMINID'
    end
    object tFADDRESS: TStringField
      FieldName = 'ADDRESS'
      Size = 254
    end
    object tFTEL: TStringField
      FieldName = 'TEL'
      Size = 50
    end
    object tFJOB: TStringField
      FieldName = 'JOB'
    end
    object tFCARD: TFloatField
      FieldName = 'CARD'
    end
    object tFGRADE: TFloatField
      FieldName = 'GRADE'
    end
    object tFMUG: TStringField
      FieldName = 'MUG'
      Size = 50
    end
    object tFMILEAGE: TFloatField
      FieldName = 'MILEAGE'
    end
    object tFUSEDMILEAG: TFloatField
      FieldName = 'USEDMILEAG'
    end
    object tFMEMO: TStringField
      FieldName = 'MEMO'
      Size = 254
    end
  end
