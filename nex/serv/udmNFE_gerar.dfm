object dmNFE_gerar: TdmNFE_gerar
  ...
  object tbrtrib_tipo: TnxTable
    ...
    object tbrtrib_tiponatop: TWideStringField
      FieldName = 'natop'
      Size = 60
    end
