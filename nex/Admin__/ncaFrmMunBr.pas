...
type
  ...
  public
    ...
    function Pesquisar(aUF: String; var aCodigo: String): Boolean;
...
function TFrmMunPesq.Pesquisar(aUF: String; var aCodigo: String): Boolean;
begin
  FUpdating := True;
  try
    FUF := aUF;
...
begin
  ...
  try
    if Trim(edBusca.Text)='' then begin
      ...
      Tab.SetRange([FUF, edBusca.Text], [FUF, edBusca.Text+'zzzzzzzzzzzzzzzzzzzzz']); // do not localize
    end;
  finally
    Tab.EnableControls;
  end;
