...
{      if tNFConfigAmbiente.Value=2 then
        ...
        TFrmOpcoes.Create(Self).Editar('Opções para Vendas', [TFrmConfigRec_PgDebito, tFrmConfigRec_Pedido, tFrmConfig_Gaveta, F, TFrmConfigQuickCad, TFrmConfigCodProdutoDuplicado, TFrmConfigVendaProdSemSaldo, TFrmConfigCodBarBal, TFrmConfigComissao, TFrmConfigPosVenda], True);
     end else 
       TFrmOpcoes.Create(Self).Editar('Opções para Vendas', [TFrmConfigRec_Venda, TFrmConfigRec_PgDebito, TFrmConfigRec_Pedido, TFrmConfig_Gaveta, TFrmConfigQuickCad, TFrmConfigCodProdutoDuplicado, TFrmConfigVendaProdSemSaldo, TFrmConfigCodBarBal, TFrmConfigComissao, TFrmConfigPosVenda], True);
