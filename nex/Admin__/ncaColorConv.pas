...
function ColorMin(P1,P2,P3: double): Double;
function ColorMax(P1,P2,P3: double): Double;
function HLSToColor(H,L,S: Integer): TColor;
implementation
...
begin
    ...
    Result.G := 0;
    Result.B := 0;
    while i - 65536 >= 0 do begin i := i - 65536; Result.B := Result.B + 1;
end;
