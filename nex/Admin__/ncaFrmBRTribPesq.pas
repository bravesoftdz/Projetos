...
begin
  TFrmBRTrib.Create(Self).Editar(False, Tab);
end;
...
begin
  TFrmBRTrib.Create(Self).Editar(True, Tab);
end;
...
begin
  with Dados do 
    panPadrao.Visible := (TabID.Value<>tNFConfigTrib_Padrao.Value) and (not Tab.IsEmpty);
end;
