...
type
  TfbExtratoFid = class(TFrmBase)
    ...
    TabTipoItem: TByteField;
    TabSubTipo: TByteField;
    TabItemID: TLongWordField;
    TabSubItemID: TLongWordField;
    TabItemPos: TByteField;
    ...
    TabFidFator: TShortintField;
    TabSessao: TLongWordField;
    TabFidOpe: TByteField;
