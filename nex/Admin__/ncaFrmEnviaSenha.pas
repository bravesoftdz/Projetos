...
type
  ...
  public
    ...
    procedure Mostrar(aEmail, aUsers: String);
    { Public declarations }
  end;
...
uses ncKiteApi, ncClassesBase, ncaDM, ncaFrmLogin;
...
procedure TFrmEnviaSenha.Mostrar(aEmail, aUsers: String);
begin
  FEmail := aEmail;
  FUsers := aUsers;
  lbEmail.Caption := FEmail;
  ShowModal;
end;
...
begin
  ...
  with TThSendEmail.Create(FEmail, FUsers) do begin
