...
begin
  ...
  try
    ...
    Dict.FieldsDescriptor.AddField('Memo', '', nxtBlobMemo, 0, 0, False);
    ...
    with Dict.IndicesDescriptor.AddIndex('byToken', 0, True, '', TnxMainIndexTokenKeyDescriptor) do begin
      with (KeyDescriptor as TnxMainIndexTokenKeyDescriptor) do begin
    ...
    with EnsureFulltextDescriptor(Dict) do begin
      with AddFullTextIndex('StringWords', nil, 1) do begin
        ...
        with TnxMainIndexTokenIndexDescriptor(AddTokenIndex('ByWord', TnxMainIndexTokenIndexDescriptor)) do begin
          MainIndexNumber := 2;
          IgnoreCase := True;
        end;
      end;
...
begin
  nxTable2.SetRange([Edit3.Text], [Edit3.Text+'zzzzzzzz']);
end;
