...
//      RefreshTotais;
      FSessao.ObsFim := FTot.edObs.Text;
...
begin
  ...
  FTot.edObs.Text := FSessao.ObsFim;
  ...
  LeTran;
  FTot.InitVal(aSessao.TotalGeral, aSessao.DescTran, aSessao.PagoTran, 0, aSessao.ObsFim, panTot2);
