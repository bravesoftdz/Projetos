...
const
  ...
  SHttpAssinarNextarComBrConta = 'http://assinar.nextar.com.br?conta=';
    ...
    if (gConfig.AssinaturaVenceEm<Date) then begin
      ...
      case Dias of
        ...
        1 : begin
          ...
          btnAss.Caption := SncaFrmPri_SuaAssinaturaPremiumVenceAMANHÃ;
        end;
        2 : begin
...
begin
  ...
  S := SncaFrmPri_Versão + prefixo_versao + Copy(SelfVersion, 7, 20);
...
begin
  ShellStart(SHttpAssinarNextarComBrConta+gConfig.Conta);
end;
...
begin
  ...
  FBiometria := False;
  RegistraForms;
  cmVerCod.Caption := SncaFrmPri_Versão_2 + VerProg + SncaFrmPri_Conta + Dados.CM.Config.Conta + '  |';
  try
