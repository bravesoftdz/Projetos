...
type
  ...
  public
    ...
    procedure Customize(aWindows, aBobina: Boolean);
    { Public declarations }
  end;
...
uses ncClassesBase, ncaDM, ncDebug, inifiles;
...
procedure TdmComp.Customize(aWindows, aBobina: Boolean);
var 
...
begin
  ...
  txtExp.FileName := ExtractFilePath(ParamStr(0))+S_ReciboTxt;
...
begin
      ...
      begin
        ...
        begin
          R := repWinBFS;
          DebugMsg('TdmComp.ImprimeWindows - repBobinaWinFS');
        end else begin
          R := repWinFS;
          DebugMsg('TdmComp.ImprimeWindows - repJTFS');
        end;
      end else begin
        if gConfig.RecMatricial then begin
          DebugMsg('TdmComp.ImprimeWindows - repBobinaWin');
          R := repWinB;
        end else begin
          R := repWin;
          DebugMsg('TdmComp.ImprimeWindows - repJT');
        end;
      end;
