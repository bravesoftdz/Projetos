...
begin
  ...
  for I := 0 to Count - 1 do 
    Result := Result + Itens[I].AsString + sListaDelim(classid_TncCredTempos);
end;
...
procedure TncCredTempos.SetString(Value: String);
var S: String;
begin
  Limpa;
  while GetNextListItem(Value, S, classid_TncCredTempos) do 
    NewItem.AsString := S;
end;
