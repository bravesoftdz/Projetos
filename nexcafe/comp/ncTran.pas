...
begin
  ...
  for I := 0 to Count - 1 do 
    Result := Result + Itens[I].AsString + sListaDelim(classid_TncTransacoes);
end;
...
procedure TncTransacoes.SetString(Value: String);
var S: String;
begin
  Limpa;
  while GetNextListItem(Value, S, classid_TncTransacoes) do
    NewTran.AsString := S;
end;
