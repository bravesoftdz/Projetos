...
type
  ...
  public
    function Editar(const aNovo, aSalvar: Boolean; aPagEsp: TncPagEspecies; aDados: PDadosTempo; aTran: Integer; aMostraAvulso: Boolean = False; aMinutosT: Double=0; aValorT: Currency=0; aRemovePos: Boolean=False): Boolean;
    { Public declarations }
  end;
...
function TFrmTempo.Editar(const aNovo, aSalvar: Boolean; aPagEsp: TncPagEspecies; aDados: PDadosTempo; aTran: Integer; aMostraAvulso: Boolean = False; aMinutosT: Double=0; aValorT: Currency=0; aRemovePos: Boolean=False): Boolean;
var 
  TC: Integer; D: Double;
begin
  ...
  if FidResg then begin
    ...
    FTot.InitVal(FPagEsp, aDados^.dtValor, aDados^.dtDesc, aDados^.dtDesc, 0, aDados^.dtObs, panTot);
    tTipoTempo.Filter := '';
