...
begin
  inherited;
  TFrmOpcoes.Create(Self).Editar('Opções para Vendas', [TFrmConfigRec, TFrmConfigQuickCad, TFrmConfigCodProdutoDuplicado, TFrmConfigVendaProdSemSaldo, TFrmConfigCodBarBal, TFrmConfigComissao], True);
end;
