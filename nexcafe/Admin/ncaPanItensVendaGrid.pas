...
begin
  ...
  if ResgateFidelidade then
    TVDescr.Width := Grid.Width - TVItem.Width - TVQuant.Width - TVVezes.Width - TVFidPontos.Width - TVIgual.Width - TVFidPontosTotal.Width
  else
  if TVUnitario.Visible then
    ...
    TVDescr.Width := Grid.Width - TVItem.Width - TVQuant.Width;
...
begin
  ...
  if RecordCount>1 then
    lbItens.Caption := IntToStr(RecordCount) + ' ' + sItens else
