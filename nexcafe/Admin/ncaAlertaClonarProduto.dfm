inherited panAlertaClonarProduto: TpanAlertaClonarProduto
  Width = 1024
  ExplicitWidth = 1024
  inherited panPri: TLMDSimplePanel
    ...
    inherited lbMensagem: TcxLabel
      Left = 163
      Caption = 
        'Esta op'#231#227'o serve para facilitar o cadastro de produtos com dados' +
        ' semelhantes evitando que tenha que redigitar informa'#231#245'es repeti' +
        'das.'
