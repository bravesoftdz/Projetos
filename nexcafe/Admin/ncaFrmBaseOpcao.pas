...
type
  ...
  protected
    ...
    procedure RenumCB(aCB: TcxCheckBox; aNumItem: Byte);
...
procedure TFrmBaseOpcao.RenumCB(aCB: TcxCheckBox; aNumItem: Byte);
begin
  aCB.Caption := RenumCaption(aCB.Caption, aNumItem);
end;
