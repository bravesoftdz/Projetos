...
resourcestring
  ...
  rsUltimoDiaExt = 'Seu plano PREMIUM está ativo. Hoje é o último dia para realizar o pagamento da sua assinatura e evitar que sua assinatura seja desativada';
  rsDias = 'dias';
  rsDia  = 'dia';
