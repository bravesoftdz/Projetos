...
uses
  ...
  cxGridPopupMenu, cxClasses, ExtCtrls, cxGraphics, Menus, ncafbTiposImp,
  ...
  cxPCdxBarPopupMenu, uParentedPanel, dxPScxPivotGridLnk;
...
begin
  ...
  fbTiposImp := TfbTiposImp.Create(Self);
  fbTiposImp.panPri.Parent := nbgImpControl;
  ...
  with fbTiposImp.panPri.Margins do begin
    Left := 10;
    Right := 10;
    Top := 10;
    Bottom := 10;
  end;
  fbTiposImp.panPri.AlignWithMargins := True;
end;
