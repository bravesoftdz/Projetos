...
begin
  ...
  if Erros >0 then ShowMessage('Erro na importação de ' + IntToStr(Erros) + ' cliente(s)');
  ...
  if Erros >0 then ShowMessage('Erro na importação do crédito de tempo de ' + IntToStr(Erros) + ' cliente(s)');
