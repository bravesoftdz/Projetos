...
type
  TForm16 = class(TForm)
    ...
    tFUF: TStringField;
    tFENDEREO_C: TStringField;
    tFBAIRRO_COM: TStringField;
    tFCEP_COMERC: TStringField;
    tFCIDADE_COM: TStringField;
    tFTELEFONE_C: TStringField;
    ...
    tFMOTIVO: TMemoField;
    tFFUNCIONRI: TFloatField;
    tFMODOACESSO: TFloatField;
    tFHORASPR: TFloatField;
...
begin
  ...
  while not TF.eof do begin
    ...
    if (TFCodigo.Value>=1) and (TFVisita.Value>=Data6) then begin
      ...
      tCliDataNasc.Value := TFNasc.Value;
