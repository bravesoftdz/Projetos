object FrmPri: TFrmPri
  ...
  object IBDatabase1: TIBDatabase
    DatabaseName = '127.0.0.1/3050:C:\Nexcafe\VSCYBER.GDB'
    Params.Strings = (
      'user_name=sysdba'
      'password=masterkey')
    LoginPrompt = False
  ...
  object tDataNasc: TIBTable
    ...
    IndexDefs = <
      ...
      item
        Name = 'DATAPESSOA_AK1'
        Fields = 'SITPDATA;IDPESSOA'
        Options = [ixUnique]
      end
      item
        Name = 'TPDATA_DATAPESSOA'
        Fields = 'SITPDATA'
      end
      item
        Name = 'PESSOA_DATAPESSOA'
        Fields = 'IDPESSOA'
      end>
    StoreDefs = True
  ...
  object tRG: TIBTable
    ...
    IndexDefs = <
      ...
      item
        Name = 'IDENTFPESS_AK1'
        Fields = 'IDPESSOA;SITPIDENTF'
        Options = [ixUnique]
      end
      item
        Name = 'PESSOA_IDENTFPESS'
        Fields = 'IDPESSOA'
      end
      item
        Name = 'TPIDENTF_IDENTFPESS'
        Fields = 'SITPIDENTF'
      end>
    StoreDefs = True
  ...
  object OpenDlg: TOpenDialog
    FileName = 'C:\Nexcafe\VSCYBER.GDB'
  ...
  object tAd: TIBTable
    ...
    IndexDefs = <
      item
        Name = 'PESSXFORMACNTT_PK'
        Fields = 'IDPESSXFORMACNTT'
        Options = [ixUnique]
      end
      item
        Name = 'PESSXFORMACNTT_IE1'
        Fields = 'REFERENCIA'
      end
      item
        Name = 'LOCD_PESSXFORMACNTT'
        Fields = 'IDLOCD'
      end
      item
        Name = 'FORMACNTT_PESSXFORMACNTT'
        Fields = 'IDFORMACNTT'
      end
      item
        Name = 'PESSOA_PESSXFORMACNTT'
        Fields = 'IDPESSOA'
      end>
    StoreDefs = True
  ...
  object tSexo: TIBTable
    ...
    IndexDefs = <
      item
        Name = 'PESSOAFISICA_PK'
        Fields = 'IDPESSOA'
        Options = [ixUnique]
      end
      item
        Name = 'PESSOA_PESSOAFISICA'
        Fields = 'IDPESSOA'
      end>
    StoreDefs = True
