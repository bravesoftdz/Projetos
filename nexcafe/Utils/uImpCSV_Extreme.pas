...
function MeuTrim(aStr: String): String;
var 
   I: Integer; 
begin
  Result := Trim(aStr);
...
//  for J := 1 to 2 do 
  for I := 1 to SL.Count-1 do begin
    ...
    try
      s4 := ProxCampo;
      tCli.Insert;
      tCliID.Value := StrToInt(SoDig2(s4));
      ...
      tCliMinutos.Value := tCliMinutos.Value + StrToIntDef(ProxCampo, 0);
      ProxN(3);
      ...
      tCliNaoGuardarCredito.Value := True;
