...
uses unxInst_Folder, ncFirewall;
...
begin
  if Process('NexGuard.exe').IsValid then begin
    ShowMessage('Para instalar é necessário fechar o programa NexGuard.');
    Close;
  end;
end;
