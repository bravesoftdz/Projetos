...
var
    ...
    function postmsg(amsg, aWParam, aLParam: integer):boolean;
    var j: integer;
    begin
      result := false;
      if hwnd_server=0 then begin
        ...
        for j:=p.ItemCount-1 downto 0 do begin
            sleep(1);
            result := p[j].Windows_.PostMessage( WM_ENDPRINT_MESSAGE, aWParam, aLParam);
        end;
      end else
        result := PostMessage(hwnd_server, amsg, aWParam, aLParam);
    end;
        ...
        {$IFNDEF NOLOG} GLog.Log(nil,[lcTrace],'procDoc');{$ENDIF}
         ...
         try
                    ...
                    if not ( fileexists(fFullDestDirName+inttostr(i)+'.bnexprint') and
                        ...
                        try
                            ...
                            if i=1 then begin
                                ...
                                GetAtomMD5;
                                PostMsg(WM_AFTERPRINTSTART, wParam, lParam);
            ...
            for j:=p.ItemCount-1 downto 0 do begin
                ...
                GetAtomMD5;
                repeat
                    res := PostMsg(WM_STARTPRINT_MESSAGE, wParam, lParam);
            ...
            for i:=6 to fPDFDocument.PageCount do begin
                ...
                for j:=p.ItemCount-1 downto 0 do begin
                    ...
                    try
                        ...
                        PostMsg(WM_PROGRESS_MESSAGE, wParam, lParam);
                    finally
                        fMessageStr.free;
                    end;
                 end;
...
begin
    ...
    GetAtomMD5;
    PostMsg(WM_AFTERPRINTENDS, wParam, lParam);
