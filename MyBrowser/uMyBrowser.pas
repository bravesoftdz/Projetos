...
type
  ...
  public
    ...
    function MasterDoc(pDisp: IDispatch): Boolean;
    function BodyHtml(pDisp: IDispatch): String;  
    function Doc2: IHTMLDocument2;
  published
...
function TMyBrowser.Doc2: IHTMLDocument2;
begin
...
function TMyBrowser.MasterDoc(pDisp: IDispatch): Boolean;
begin
  Result := (pDisp = DefaultInterface);
end;

procedure Register;
begin
  RegisterComponents('NexCafe', [TMyBrowser]);
end;
